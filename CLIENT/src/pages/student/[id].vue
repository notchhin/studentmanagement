...
const submitHandler = async () => {
  ...
  if (valid) {
    ...
    if (formDataLocal.value.photo_path !== null && formDataLocal.value.photo_path !== undefined) {
      ...
      <VCard :title="$t('update student')">
        <VCardText class="d-flex">
          ...
          <VAvatar
            ...
            size="100"
            class="me-6"
            :image="formDataLocal.photo_path ? additional_image : (localImage ? constant.storagePath + localImage : additional_image)"
          />
