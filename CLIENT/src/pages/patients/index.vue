...
const viewCallback = (item) => {
  router.push({ name: "patients-show", query: { id: item } });
};
...
<template>
  ...
  <AppDataTablePatient
    ...
    :to="meta?.to"
    :can-edit="user.can('edit patients')"
    :can-view="user.can('view patients')"
    :can-create="user.can('create patients')"
